...
export function FocusRail({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[640px] w-full flex-col overflow-hidden bg-neutral-950 text-white outline-none select-none overflow-x-hidden",
        className,
      )}
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <AnimatePresence mode="popLayout">
          ...
          >
            <Image
              src={activeItem.images[0].src}
              width={1920}
              height={1080}
              alt={activeItem.images[0].altText}
      ...
      {/* Main Stage */}
      <div className="relative z-10 flex flex-1 flex-col justify-center items-center mt-35 px-4 md:px-8">
        {/* DRAGGABLE RAIL CONTAINER */}
        <motion.div
          className="relative mx-auto flex h-full w-full max-w-6xl items-center justify-center perspective-[1200px] cursor-grab active:cursor-grabbing"
          drag="x"
          ...
          {visibleIndices.map((offset) => {
            ...
            return (
              <motion.div
                key={absIndex}
                className={cn(
                  "absolute aspect-video w-full rounded-2xl bg-neutral-900 duration-300",
        ...
        {/* Info & Controls */}
        <div className="mx-auto mt-12 flex w-full flex-col items-center justify-between gap-6 md:flex-row pointer-events-auto">
