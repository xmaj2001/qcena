import { BadgeCheck, MessageCircle, ChevronRight, Package, MapPin, ShieldCheck } from "lucide-react";
import Link from "next/link";

export function Hero2() {
    return (
        <section className="px-4 pb-8 md:px-8 mt-20 relative rounded-3xl bg-kente shadow-card">
