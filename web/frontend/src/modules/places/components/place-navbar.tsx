...
import { Button, CloseButton, Label, Menu, SearchField } from "@heroui/react";
import Image from "next/image";
import Link from "next/link";
import { useEffect, useState } from "react";

interface PlaceNavbarProps {
  searchQuery: string;
  onSearchChange: (query: string) => void;
}

export function PlaceNavbar({ searchQuery, onSearchChange }: PlaceNavbarProps) {
  const navLinks = [
    { name: "Todos", href: "/places" },
    { name: "Beleza", href: "/places/beauty" },
    { name: "Fitness", href: "/places/fitness" },
  ];
      ...
      >
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link
              href="https://github.com/xmaj2001/qcena"
              target="_blank"
