import { ServiceCollection } from "./types/service.type";

export const COLLECTIONS: ServiceCollection[] = [
  {
    id: "1",
    title: "SPA",
    slug: "spa",
